...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <h1 class="mb-3">{{__('app.app_name')}}</h1>
            <div class="card">
                <div class="card-header">{{ __('login.registration') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('login.e_mail') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('login')  }}" class="btn btn-xs btn-danger pull-right">
